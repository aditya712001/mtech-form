...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        //SELECT * FROM `mtp_users`
        $sql = "SELECT id FROM mtp_users1 WHERE username = ?";
        //$sql = "SELECT * FROM mtp_users WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO mtp_users1 (username, password) VALUES (?, ?)";
